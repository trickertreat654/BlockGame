...
const gridSize = 10;
const grid = ref(Array.from({ length: gridSize }, () => Array.from({ length: gridSize }, () => ({}))));
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
          <div class="flex flex-col game-container">
            <div v-for="(row, rowIndex) in grid" :key="rowIndex" class="flex grid-row">

              <!-- :key="cellIndex" -->
              <GameBox v-for="(cell, cellIndex) in row" :key="cellIndex"
